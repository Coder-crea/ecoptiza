      ...
      <div className="reviews">
        ...
        <div className="reviews-grid">
          <div className="review-card">
            ...
            <p>
              Готовили курицу на праздничный ужин — все в восторге! Мясо
              необычайно сочное и ароматное. Теперь только ваша птица у нас на
              столе.
            </p>
          </div>
          <div className="review-card">
            ...
            <p>
              Заказываю регулярно. Всё по графику, доставка быстрая. Особенно
              радует честная упаковка и отсутствие "воды" в мясе.
            </p>
          </div>
          <div className="review-card">
            <div className="review-header">
            ...
            <p>
              Дети едят с удовольствием! Спасибо за качество и заботу о
              здоровье. Теперь перешли на вашу птицу полностью.
            </p>
          </div>
        </div>
      </div>
